                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pills">
                                <Link to={WebRoutes.PHOTO_GALLARY} class="active">Photo Gallery</Link>
                            ...
                            <div class="row">
                                <div class="col-md-12 box-radius">
                                    ...
                                    <div class="articles gallery-cards">
                                        {galleryData && galleryData.data && galleryData.data.map((item) =>
                                            <div class="article">
                                                <div class="thumbnail">
                                                    <a href="#">
                                                        <img src="../assets/imgs/gallery1.png" alt="image" />
                                                    </a>
                                                </div>
