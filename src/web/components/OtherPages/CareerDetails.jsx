                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><Link to={WebRoutes.CAREER}> Career</Link></li>
                                <li class="breadcrumb-item active" aria-current="page">{jobDetails && jobDetails.data && jobDetails.data.title}</li>
                            </ol>
                        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="job-info">
                            ...
                            <div class="info">
                                <p>Posted on</p>
                                <p>{jobDetails && jobDetails.data && jobDetails.data.created_at}</p>
                            </div>
                        </div>
                    </div>
