...
function WhyMtEducare() {
  return (
    <>
      <section class="why-mt-educare">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center">
                Why <span class="text-orange">MT Educare</span>
              </h3>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="mt-card bg-light-blue">
                ...
                <p>Our all-inclusive syllabus and study material make certain that MT Educare students are ready to take on the industry by storm.</p>
              </div>
            </div>
