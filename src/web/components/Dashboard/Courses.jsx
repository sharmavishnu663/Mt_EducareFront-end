             ...
             <div className="article-header">
                <div className="pills">
                  ...
                  <Link to="/courses/competativeExams" className="active">
                    ...
                    <Link to="/courses/college" >
                      College
                    </Link>
                    <Link to="/courses/school" >
                      School
                    </Link>
              ...
              <div className="articles">
                  ...
                  <div className="detail">
                    ...
                    <div className="description">
                      <p>
                        ...
                        who go on to become world-className engineers and
                        technologists.
                      </p>
                    </div>
                ...
                <div className="article">
                  ...
                  <div className="detail">
                    ...
                    <div className="description">
                      <p>
                        NEET is the most important exam for medical aspirants,
                        as it is required for them to join the best medical
                ...
                <div className="article">
                  ...
                  <div className="detail">
                    ...
                    <div className="description">
                      <p>
                        National Talent Search Examination is one of the most
                        recognized examinations in India which is conducted by
                        NCERT.
                      </p>
                    </div>
                    <div className="tag-link">
